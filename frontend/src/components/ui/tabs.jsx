...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center rounded-lg bg-[var(--color-clawde-parchment)] p-1 text-[var(--color-clawde-charcoal)] border border-[#E2D9CC]",
      className
    )}
    {...props}
  />
